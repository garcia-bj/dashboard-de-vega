        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer"><input type="checkbox" className="rounded accent-primary" /><span className="text-muted-foreground">Recordarme</span></label>
              <button type="button" className="text-primary font-medium text-sm">¿Olvidó contraseña?</button>
            </div>
          ...
          <div className="mt-8 pt-6 border-t text-center text-xs text-muted-foreground">
            <span>Soporte</span><span className="mx-2">•</span><span>Privacidad</span>
          </div>
        </div>
      </div>
    </div>
